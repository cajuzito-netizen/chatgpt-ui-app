    ...
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-6 py-8">
      ...
      <div className="mt-1 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-xl text-[15px] leading-relaxed text-ink-secondary dark:text-dark-ink-secondary">
            {APP_TAGLINE}
          </p>
        </div>
        <Link
      ...
      <section className="mt-10">
        <div className="mb-3 flex items-center justify-between gap-2">
          <h2 className="text-[13px] font-medium uppercase tracking-wide text-ink-tertiary">
            Recent
          </h2>
          <Link
            to={`/w/${id}/items`}
            className="text-[13px] font-medium text-link hover:underline dark:text-dark-link"
          >
            View all
          </Link>
        </div>
